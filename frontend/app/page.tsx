...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-notebook to-paper">
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="text-5xl md:text-7xl font-bold text-foreground mb-6">
              Transform Your
              <span className="block text-primary">Studying Habits</span>
            </h1>
            <p className="text-xl md:text-2xl text-foreground/80 max-w-3xl mx-auto leading-relaxed">
              Upload your instructor videos, worksheets, and notes. Click on <span className="font-bold underline hover:cursor-pointer">any</span> problem to instantly find what you need to know across all your materials.
            </p>
          </div>
      ...
      <section id="demo" className="py-28 px-4 sm:px-6 lg:px-8 bg-secondary">
        {/* EMBED VIDEO HERE WITH DEMO */}
      ...
      <section id="features" className="py-24 px-4 sm:px-6 lg:px-8 bg-white/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-foreground mb-4">Everything You Need to Excel at School.</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-8 shadow-lg border border-primary/10">
              ...
              <p className="text-foreground/70">
                Upload your class recordings and lecture notes. Our system automatically indexes key moments for easy reference.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border border-primary/10">
              ...
              <p className="text-foreground/70">
                Keep your notes and study materials organized. We can link them directly to specific problems and concepts.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border border-primary/10">
              ...
              <p className="text-foreground/70">
                Upload PDF worksheets and marked assignments or tests. Click on any problem to find related video explanations and notes.
              </p>
            </div>
      ...
      <section id="how-it-works" className="py-24 px-4 sm:px-6 lg:px-8 bg-notebook">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-foreground mb-4">How It Works</h2>
            <p className="text-xl text-foreground/70 max-w-2xl mx-auto">
              Three simple steps to transform your student learning experience.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-foreground/70">
                Upload your class videos, worksheets, and notes to your personal workspace.
              </p>
            </div>

            <div className="text-center">
              <div className="w-16 h-16 bg-secondary/50 text-white rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-6">
                2
              </div>
      ...
      {/* CTA Section */}
      <section id="get-started-now"className="py-24 px-4 sm:px-6 lg:px-8 bg-foreground">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-white mb-6">Ready to Transform Your Class Learning?</h2>
          <p className="text-xl text-white/90 mb-8">
            Join our community of students who are already learning more efficiently with Marker.
          </p>
