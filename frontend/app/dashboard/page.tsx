...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-notebook">
      ...
      <div className="flex">
        {/* Sidebar */}
        <aside className="w-64 bg-white border-r border-primary/20 min-h-screen">
          <div className="p-6">
            <h2 className="text-lg font-semibold text-foreground mb-6">Your Library</h2>
              ...
              <div className="space-y-3">
                <label className="block">
                  <input
                    ...
                    className="hidden"
                  />
                  <div className="bg-primary/10 text-primary px-4 py-3 rounded-lg text-sm hover:bg-primary/20 transition-colors cursor-pointer text-center">
                    📹 Upload Videos
                  </div>
                </label>
                <label className="block">
                  <input
                    ...
                    className="hidden"
                  />
                  <div className="bg-secondary/10 text-secondary px-4 py-3 rounded-lg text-sm hover:bg-secondary/20 transition-colors cursor-pointer text-center">
                    📄 Upload PDFs
                  </div>
                </label>
              </div>
